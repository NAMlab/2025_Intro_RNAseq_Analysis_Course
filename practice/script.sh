...
kallisto quant -i genomes/Solanum_lycopersicum.SL3.0.cdna.all.index -o mapped/LMC -t 4 --single -l 50 -s 30 data/SRR2006793.fastq.gz
kallisto quant -i genomes/Solanum_lycopersicum.SL3.0.cdna.all.index -o mapped/AMC -t 4 --single -l 50 -s 30 data/SRR2006797.fastq.gz
kallisto quant -i genomes/Solanum_lycopersicum.SL3.0.cdna.all.index -o mapped/LWS -t 4 --single -l 50 -s 30 data/SRR2006792.fastq.gz
kallisto quant -i genomes/Solanum_lycopersicum.SL3.0.cdna.all.index -o mapped/LMS -t 4 --single -l 50 -s 30 data/SRR2006794.fastq.gz
kallisto quant -i genomes/Solanum_lycopersicum.SL3.0.cdna.all.index -o mapped/LWC -t 4 --single -l 50 -s 30 data/SRR2006791.fastq.gz
kallisto quant -i genomes/Solanum_lycopersicum.SL3.0.cdna.all.index -o mapped/AWC -t 4 --single -l 50 -s 30 data/SRR2006795.fastq.gz
kallisto quant -i genomes/Solanum_lycopersicum.SL3.0.cdna.all.index -o mapped/AWS -t 4 --single -l 50 -s 30 data/SRR2006796.fastq.gz
kallisto quant -i genomes/Solanum_lycopersicum.SL3.0.cdna.all.index -o mapped/AMS -t 4 --single -l 20 -s 30 data/SRR2006798.fastq.gz
